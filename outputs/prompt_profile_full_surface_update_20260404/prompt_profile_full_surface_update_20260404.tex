...
\begin{itemize}[leftmargin=1.5em]
\item Combined note: \texttt{docs/prompt-profile-full-surface-update-2026-04-04.md}
\item Combined PDF: \path{outputs/prompt_profile_full_surface_update_20260404/prompt_profile_full_surface_update_20260404.pdf}
\item Combined TeX: \path{outputs/prompt_profile_full_surface_update_20260404/prompt_profile_full_surface_update_20260404.tex}
\item Underlying locked full-train bundle: \path{outputs/prompt_profile_full_train_locked_pair_20260404/}
\item Underlying binary capacity bundle: \path{outputs/prompt_profile_binary_capacity_controls_20260404/}
\end{itemize}
