...
`scripts/mechanism_analysis/export_prompt_profile_projection.py` writes:

- `prompt_projection.csv`
- `projection_summary.json`

`scripts/plot/render_prompt_profile_projection.py` renders:
...
```bash
python scripts/mechanism_analysis/export_prompt_profile_projection.py \
...
```bash
python scripts/plot/render_prompt_profile_projection.py \
