...
- Canonical artifact:
  - `docs/weeks/2026-W14/prompt-profile-natural-regression-rerun-2026-04-05.md`
  - `outputs/weeks/2026-W14/prompt_profile_natural_regression_rerun_20260405/prompt_profile_natural_regression_rerun_20260405.pdf`
...
- Capacity-control artifact:
  - `docs/weeks/2026-W14/prompt-profile-binary-capacity-controls-2026-04-04.md`
...
- regression source root:
  - `outputs/weeks/2026-W14/prompt_profile_natural_regression_rerun_20260405/` via the reused shared archives
- binary source root:
  - `outputs/weeks/2026-W14/prompt_profile_full_train_locked_pair_20260404/`
- saved audit bundle:
  - `outputs/weeks/2026-W14/prompt_profile_metadata_audit_20260405/`
...
- `scripts/train/run_prompt_profile_full_train.py`
- `scripts/report_generation/summarize_prompt_profile_full_train.py`
- `scripts/train/train_probe.py`
- `scripts/train/train_metadata_residual_probe.py`
- `src/probe/labeling.py`
- `scripts/mechanism_analysis/audit_prompt_metadata_correlations.py`
- `outputs/weeks/2026-W14/prompt_profile_metadata_audit_20260405/metadata_correlation_summary.json`
...
- Combined audit PDF:
  - `outputs/weeks/2026-W14/prompt_profile_combined_audit_20260405/prompt_profile_combined_audit_20260405.pdf`
- Combined audit TeX:
  - `outputs/weeks/2026-W14/prompt_profile_combined_audit_20260405/prompt_profile_combined_audit_20260405.tex`
