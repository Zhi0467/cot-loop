...
- Fresh rerun output root:
  - `outputs/prompt_profile_natural_regression_rerun_20260405/`
...
- Original regression ledger:
  - `outputs/prompt_profile_full_train_locked_pair_20260404/remote_summary/cross_dataset_summary.json`
- Fresh rerun ledger:
  - `outputs/prompt_profile_natural_regression_rerun_20260405/remote_summary/cross_dataset_summary.json`
...
- Fresh copied summary ledger:
  - `outputs/prompt_profile_natural_regression_rerun_20260405/remote_summary/`
- Fresh Slurm log:
  - `outputs/prompt_profile_natural_regression_rerun_20260405/logs/prompt-profile-regression-natural-2215.out`
