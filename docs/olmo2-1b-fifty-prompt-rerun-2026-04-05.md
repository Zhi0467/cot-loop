...
This note is the larger follow-up to the bounded OLMo2 `1B` fallback ladder from `docs/olmo-degeneration-origin-audit-2026-04-04.md`.
...
Operational note:
- the first replay attempt died after generation because `scripts/collect_model_stats.py` wrote `top_p` / `top_k` from undefined names in `main()`;
...
- Earlier smaller audit: `docs/olmo-degeneration-origin-audit-2026-04-04.md`
- PDF companion: `outputs/olmo2_1b_fifty_prompt_rerun_20260405/olmo2_1b_fifty_prompt_rerun_20260405.pdf`
- PDF source: `outputs/olmo2_1b_fifty_prompt_rerun_20260405/olmo2_1b_fifty_prompt_rerun_20260405.tex`
