...
- source regression root:
  - `outputs/prompt_profile_natural_regression_rerun_20260405/` on the saved remote archive
- new audit bundle:
  - `outputs/prompt_profile_length_mechanism_20260409/`
- GPU execution:
  - `slurm/run_prompt_profile_length_mechanism_audit.sbatch`
  - `2` GPUs on `tianhaowang-gpu0`
  - copied local log: `outputs/prompt_profile_length_mechanism_20260409/logs/prompt-profile-length-mech-2372.out`
- exact object:
...
- `outputs/prompt_profile_length_mechanism_20260409/athena_length_mechanism_context.md`
