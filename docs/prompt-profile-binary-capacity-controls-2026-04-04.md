...
- Proven now:
  - `ensemble h256 d1` is the strongest single global surface in this capacity sweep
  - `ensemble h256 d1` still beats the prompt-length baseline on all five datasets by `PR-AUC`
  - `last_layer h256 d2` is better than `last_layer h256 d1` on every dataset, but it is still weaker than `ensemble h256 d1` as a global choice
- Also proven:
...
- If the project wants separate best-by-view surfaces:
  - `ensemble`: `h256 d1`
  - `last_layer`: `h256 d2`
...
- PDF: `outputs/prompt_profile_binary_capacity_controls_20260404/prompt_profile_binary_capacity_controls_20260404.pdf`
- TeX: `outputs/prompt_profile_binary_capacity_controls_20260404/prompt_profile_binary_capacity_controls_20260404.tex`
- Intermediate `h256 d2` note:
  - `docs/prompt-profile-binary-retrain-h256d2-2026-04-04.md`
