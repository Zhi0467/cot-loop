...
- the collaborator-requested balanced-train / natural-test regression rerun has a corrected full-train report surface now. The durable note/PDF live at `docs/prompt-profile-balanced-regression-corrected-2026-04-04.md` and `outputs/prompt_profile_balanced_regression_corrected_20260404/prompt_profile_balanced_regression_corrected_20260404.pdf`. The earlier note `docs/prompt-profile-balanced-regression-2026-04-04.md` is retained only as a superseded downsampled-subset artifact.
